...
/**
 * This layout — not the middleware — is the authorization boundary for /acm.
 *
 ...
 */
export default async function AreaManagerLayout({ children }: { children: ReactNode }) {
  let user: SessionUser;

  try {
    user = await requireRole('acm');
  } catch (error) {
